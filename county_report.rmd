...
act_comp$variable <- paste(x$hd_tag, "Active TB Patients")
...
ltbi_comp$label <- paste(x$hd_tag, "LTBI Patients")

# Add the national target
ltbi_plot <- rbind(ltbi_comp[ , c("plot_qtr", "label", "per_complete")],
